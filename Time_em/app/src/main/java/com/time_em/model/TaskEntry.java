...
public class TaskEntry implements Parcelable {
    ...
    private String AttachmentImageFile;
    ...
    public void SetAttachementImageFile(String AttachmentImageFile) { this.AttachmentImageFile = AttachmentImageFile;  }

    public String GetAttachementImageFile() {  return AttachmentImageFile; }
